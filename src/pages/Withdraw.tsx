...
//         createdAtRaw: createdAt, // <-- add this
//         adminProofUrl,
//         screenshotUrl,
//         rawData: w,
//       } as const;
...
/** ... helper functions (generateWithdrawalOptions, formatDate, etc) remain unchanged ... */
/* (I kept these functions the same as your original file) */
...
/* -------------------- WithdrawalForm component (unchanged except receives new props) -------------------- */
/* I left the WithdrawalForm component the same; it already receives isGloballyBlocked and globalPendingCount props. */
/* ... (WithdrawalForm implementation unchanged, omitted here for brevity) ... */
